...
/*
проверка имени (не может быть1 имя больше 3
проверка пароль не менее 5 символов
месяцы огранмчениие от 1 до 12 и логичность
показания счетчиков проверить толко положительные
 */